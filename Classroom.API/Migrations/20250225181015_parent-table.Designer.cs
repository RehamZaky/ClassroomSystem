...
namespace Classroom.API.Migrations
{
    ...
    [Migration("20250225181015_parent-table")]
            ...
            modelBuilder.Entity("Classroom.API.Domain.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 2, 25, 18, 10, 15, 278, DateTimeKind.Utc).AddTicks(4615),
                            Name = "cat1",
                            UpdatedAt = new DateTime(2025, 2, 25, 18, 10, 15, 278, DateTimeKind.Utc).AddTicks(4614)
                        });
                });
            ...
            modelBuilder.Entity("Classroom.API.Domain.Entities.Classroom", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryID = 1,
                            CreatedAt = new DateTime(2025, 2, 25, 20, 10, 15, 278, DateTimeKind.Local).AddTicks(4736),
                            Description = "Object-oriented programming - OOP",
                            IsActive = true,
                            Price = 99.989999999999995,
                            Title = " #C",
                            UpdatedAt = new DateTime(2025, 2, 25, 20, 10, 15, 278, DateTimeKind.Local).AddTicks(4788)
                        },
                        new
                        {
                            Id = 2,
                            CategoryID = 1,
                            CreatedAt = new DateTime(2025, 2, 25, 20, 10, 15, 278, DateTimeKind.Local).AddTicks(4791),
                            Description = "SQL is a standard programming language used to manage and manipulate relational databases.",
                            IsActive = true,
                            Price = 120.5,
                            Title = "SQL",
                            UpdatedAt = new DateTime(2025, 2, 25, 20, 10, 15, 278, DateTimeKind.Local).AddTicks(4793)
                        },
                        new
                        {
                            Id = 3,
                            CategoryID = 1,
                            CreatedAt = new DateTime(2025, 2, 25, 20, 10, 15, 278, DateTimeKind.Local).AddTicks(4795),
                            Description = "ASP.NET Core is an open-source framework by Microsoft for building web applications",
                            IsActive = true,
                            Price = 150.0,
                            Title = "ASP.NET Core",
                            UpdatedAt = new DateTime(2025, 2, 25, 20, 10, 15, 278, DateTimeKind.Local).AddTicks(4796)
                        });
                });
